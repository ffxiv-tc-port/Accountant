...
{
    public static IGameData Create(IPluginLog log, IGameGui gui, IClientState state, IObjectTable objects, IFramework framework, IDataManager data)
        => new GameData(log, gui, state, objects, framework, data);
}
